    ...
    Protected Sub Button1_Click(sender As Object, e As System.EventArgs) Handles Button1.Click
        Try
            ...
            If login.login(TextBox1.Text.Trim, TextBox2.Text.Trim) = True Then
                ...
                If Not String.IsNullOrEmpty(Session("tid")) Then
                    auto.AuditAction(Session("name").ToString(), "Logged In")
                ...
                Else
                    auto.AuditAction(Session("name").ToString(), "Entered wrong credentials")
                ...
                End If
            Else
                auto.AuditAction(TextBox1.Text.Trim, "Entered wrong credentials")
                Label1.Text = "<div class='ui-widget'><div class='ui-state-error ui-corner-all' style='padding: 0 .7em;'><p><span class='ui-icon ui-icon-alert' style='float: left; margin-right: .3em;'></span>Wrong Login details. Try again </p></div></div>"
        ...
        Catch ex As Exception
            ...
            If ex.Message.Contains("teller") Then
                auto.AuditAction(TextBox1.Text.Trim, "Could not log in due to unupdated Teller ID")
            ...
            Else
                auto.AuditAction(TextBox1.Text.Trim, "Could not log in due to Error")
