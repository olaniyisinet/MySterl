        ...
        Try
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                For Each dr As Data.DataRow In ds.Tables(0).Rows
                    ...
                    System.IO.File.AppendAllText(AppSettings("log").ToString() & CDate(dr("VAL_DATE").ToString).ToString("dd-MMM-yyyy") & ".txt", Now & ": " & Session("name") & " generated a letter with reference Number: " & ref & " from PC IP Number:" & Request.UserHostAddress.ToString & vbCrLf)
