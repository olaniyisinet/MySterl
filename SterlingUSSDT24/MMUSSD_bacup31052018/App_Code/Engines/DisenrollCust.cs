    ...
    public string DisableCustomer(UReq req)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                if (cn > 0)
                {
                     //smsMessage = "Dear " + custName + ", your " + maskedNuban + "account is no longer enrolled for Magic Banking. Please dial *822*1*Account Number# to stay with the Magic!" + Environment.NewLine + " More enquiries? Call +23470078375464";
                    ...
                    //resp = "Your account has been disenrolled from this service.";
