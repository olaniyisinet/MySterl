...
namespace NIPHandleRequeryIMAL.NIPRequery {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="RequerySoap", Namespace="http://tempuri.org/")]
    public partial class Requery : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public Requery() {
            this.Url = global::NIPHandleRequeryIMAL.Properties.Settings.Default.NIPHandleRequeryIMAL_NIPRequery_Requery;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/requery", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        ...
        /// <remarks/>
        public void requeryAsync(string sessionid, string channelcode, string destBankCode) {
            this.requeryAsync(sessionid, channelcode, destBankCode, null);
        }
        
        /// <remarks/>
        public void requeryAsync(string sessionid, string channelcode, string destBankCode, object userState) {
            ...
            this.InvokeAsync("requery", new object[] {
                        sessionid,
                        channelcode,
                        destBankCode}, this.requeryOperationCompleted, userState);
        }
