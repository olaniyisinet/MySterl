...
namespace Doubble.MAIL.EWS {
    ...
    public interface ServiceSoap {
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        Doubble.MAIL.EWS.SendMailWithAttachmentResponse SendMailWithAttachment(Doubble.MAIL.EWS.SendMailWithAttachmentRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/SendMailWithAttachment", ReplyAction="*")]
        System.Threading.Tasks.Task<Doubble.MAIL.EWS.SendMailWithAttachmentResponse> SendMailWithAttachmentAsync(Doubble.MAIL.EWS.SendMailWithAttachmentRequest request);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ServiceSoapChannel : Doubble.MAIL.EWS.ServiceSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServiceSoapClient : System.ServiceModel.ClientBase<Doubble.MAIL.EWS.ServiceSoap>, Doubble.MAIL.EWS.ServiceSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Doubble.MAIL.EWS.SendMailWithAttachmentResponse Doubble.MAIL.EWS.ServiceSoap.SendMailWithAttachment(Doubble.MAIL.EWS.SendMailWithAttachmentRequest request) {
        ...
        public string SendMailWithAttachment(string destinationEmail, string sourceEmail, string body, string subject, string ccEmailSeparatedByComma, byte[] attachmentData, string attachmentFilename) {
            Doubble.MAIL.EWS.SendMailWithAttachmentRequest inValue = new Doubble.MAIL.EWS.SendMailWithAttachmentRequest();
            ...
            Doubble.MAIL.EWS.SendMailWithAttachmentResponse retVal = ((Doubble.MAIL.EWS.ServiceSoap)(this)).SendMailWithAttachment(inValue);
            return retVal.SendMailWithAttachmentResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<Doubble.MAIL.EWS.SendMailWithAttachmentResponse> Doubble.MAIL.EWS.ServiceSoap.SendMailWithAttachmentAsync(Doubble.MAIL.EWS.SendMailWithAttachmentRequest request) {
            return base.Channel.SendMailWithAttachmentAsync(request);
        }
        
        public System.Threading.Tasks.Task<Doubble.MAIL.EWS.SendMailWithAttachmentResponse> SendMailWithAttachmentAsync(string destinationEmail, string sourceEmail, string body, string subject, string ccEmailSeparatedByComma, byte[] attachmentData, string attachmentFilename) {
            Doubble.MAIL.EWS.SendMailWithAttachmentRequest inValue = new Doubble.MAIL.EWS.SendMailWithAttachmentRequest();
            inValue.destinationEmail = destinationEmail;
            inValue.sourceEmail = sourceEmail;
            inValue.body = body;
            ...
            inValue.attachmentData = attachmentData;
            inValue.attachmentFilename = attachmentFilename;
            return ((Doubble.MAIL.EWS.ServiceSoap)(this)).SendMailWithAttachmentAsync(inValue);
        }
