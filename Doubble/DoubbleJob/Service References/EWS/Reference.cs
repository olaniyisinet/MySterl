...
namespace DoubbleJob.EWS {
    ...
    public interface ServiceSoap {
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        DoubbleJob.EWS.SendMailWithAttachmentResponse SendMailWithAttachment(DoubbleJob.EWS.SendMailWithAttachmentRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/SendMailWithAttachment", ReplyAction="*")]
        System.Threading.Tasks.Task<DoubbleJob.EWS.SendMailWithAttachmentResponse> SendMailWithAttachmentAsync(DoubbleJob.EWS.SendMailWithAttachmentRequest request);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ServiceSoapChannel : DoubbleJob.EWS.ServiceSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServiceSoapClient : System.ServiceModel.ClientBase<DoubbleJob.EWS.ServiceSoap>, DoubbleJob.EWS.ServiceSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        DoubbleJob.EWS.SendMailWithAttachmentResponse DoubbleJob.EWS.ServiceSoap.SendMailWithAttachment(DoubbleJob.EWS.SendMailWithAttachmentRequest request) {
        ...
        public string SendMailWithAttachment(string destinationEmail, string sourceEmail, string body, string subject, string ccEmailSeparatedByComma, byte[] attachmentData, string attachmentFilename) {
            DoubbleJob.EWS.SendMailWithAttachmentRequest inValue = new DoubbleJob.EWS.SendMailWithAttachmentRequest();
            ...
            DoubbleJob.EWS.SendMailWithAttachmentResponse retVal = ((DoubbleJob.EWS.ServiceSoap)(this)).SendMailWithAttachment(inValue);
            return retVal.SendMailWithAttachmentResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<DoubbleJob.EWS.SendMailWithAttachmentResponse> DoubbleJob.EWS.ServiceSoap.SendMailWithAttachmentAsync(DoubbleJob.EWS.SendMailWithAttachmentRequest request) {
            return base.Channel.SendMailWithAttachmentAsync(request);
        }
        
        public System.Threading.Tasks.Task<DoubbleJob.EWS.SendMailWithAttachmentResponse> SendMailWithAttachmentAsync(string destinationEmail, string sourceEmail, string body, string subject, string ccEmailSeparatedByComma, byte[] attachmentData, string attachmentFilename) {
            DoubbleJob.EWS.SendMailWithAttachmentRequest inValue = new DoubbleJob.EWS.SendMailWithAttachmentRequest();
            inValue.destinationEmail = destinationEmail;
            inValue.sourceEmail = sourceEmail;
            inValue.body = body;
            ...
            inValue.attachmentData = attachmentData;
            inValue.attachmentFilename = attachmentFilename;
            return ((DoubbleJob.EWS.ServiceSoap)(this)).SendMailWithAttachmentAsync(inValue);
        }
