...
public class ErrorLog
{
    ...
    public ErrorLog(string ex)
    {
        ...
        string fileName = @"E:\AppLogs\ibs\Logs\" + DateTime.Now.ToString("yyyy_MM_dd") + ".txt";
        ...
        if (mgval.ToUpper().Contains("MB"))
        {
            ...
            if (mgIntVal > 1)
            {
                ...
                try
                {
                    File.Move(@"E:\AppLogs\ibs\Logs\" + DateTime.Now.ToString("yyyy_MM_dd") + ".txt", @"F:\AppLogs\ibsWS\errorlogs\" + DateTime.Now.ToString("yyyy_MM_dd_HHmmss") + ".txt"); // Try to move
