<%@ Page Language="VB" AutoEventWireup="false" CodeFile="mt202_cbn.aspx.vb" Inherits="mt202_cbn"     %>
    ...
    <div id="header" class="style1">
       ...
       <div class="wrap">
          ...
          <%-- &nbsp;&nbsp; |&nbsp;&nbsp; <a href="mytransactions.aspx">My Transactions</a>&nbsp;&nbsp; |&nbsp;&nbsp;&nbsp; 
           ...
           &nbsp;<a href="../trops_landing.aspx">Landing Page</a> || <a href="../../logout.aspx">Log Out</a><br />
           ...
           <fieldset>
           <legend><b>MT 202 CBN Transfers </b><asp:Label ID="lblMessageType" runat="server"></asp:Label>
    ...
    <tr>
                   ...
                   <tr>
                       ...
                       <td class="style12" valign="middle">
                           <asp:RadioButtonList ID="rblEntrySelection" runat="server">
                               <asp:ListItem Value="swift_only">SDF (SWIFT Entries only)</asp:ListItem>
                               <asp:ListItem Value="swift_and_financial">CASH RESERVATION (SWIFT and T24 Entries)</asp:ListItem>
                           </asp:RadioButtonList>
                   ...
                   <tr>
                       ...
                       <td valign="middle" class="style12">
                           <asp:DropDownList ID="ddlOwnerBranch202" runat="server" Width="301px" 
                               DataSourceID="odsBranch" DataTextField="BRANAME" DataValueField="BRACODE" Font-Names="Segoe UI Light" Height="26px" Enabled="False">
                           </asp:DropDownList><asp:ObjectDataSource ID="odsBranch" runat="server" SelectMethod="GetBranch" 
                   ...
                   <tr>
                       ...
                       <td class="style18" valign="middle">
                           ...
                           EnableClientScript="False" ValidationGroup="valGroup202"></asp:RequiredFieldValidator>
                       </td>
                   </tr>
                  <%-- <tr>
                       <td class="style5">
