...
Partial Class mt202_cbn
    ...
    Sub benefName(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim accountNum As String = txtCustAcct.Text
        ...
        If Not String.IsNullOrEmpty(name) Then
            ...
            txtCustName202.Visible = True
            txtCustName202.Text = name

        Else
            LinkButton2.Visible = True
            Label7.ForeColor = Drawing.Color.Red
            Label7.Text = "<table id='output' bgcolor='#ccffcc' width='400'><tr><td valign='middle' width='370'>Error: " & "Could not retrieve the name of this account: Message: " & errorMsg & "</td><td valign='middle' width='30'><img src='images\bad.png' width='20' title='close' onclick='hide();'></td></tr></table>"
        End If
    ...
    Private Sub mt202_cbn_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not IsPostBack Then
    ...
    Protected Sub btnSubmit202_Click(sender As Object, e As EventArgs) Handles btnSubmit202.Click
        ...
        'Check if the upload control has a file attached.
        ...
        '    lblSubmissionText202.ForeColor = Drawing.Color.Red
        '    lblSubmissionText202.Text = "<table id='output' bgcolor='#ccffcc' width='500'><tr><td valign='middle' width='470'>" & "Customer's Balance cannot handle this Transaction. N " & FormatNumber(Val(txtAmount202.Text) + charges, 2) & " is Required.</td><td valign='middle' width='30'><img src='../../images/bad.png' width='20' title='close' onclick='hide();'></td></tr></table>"
        '    Exit Sub
        ...
        Try
            ...
            If Not fupdCustInstruction.FileContent.Length > 1048576 Then
                ...
                Else
                    lblSubmissionText202.ForeColor = Drawing.Color.Red
                    lblSubmissionText202.Text = "<table id='output' bgcolor='#ccffcc' width='400'><tr><td valign='middle' width='370'>" & "Scanned Instruction must be .JPG/.PNG/.PDF" & "</td><td valign='middle' width='30'><img src='images\bad.png' width='20' title='close' onclick='hide();'></td></tr></table>"
                    btnSubmit202.Text = "Post Transaction"
                    btnSubmit202.Enabled = True
            ...
            Else
                lblSubmissionText202.ForeColor = Drawing.Color.Red
                lblSubmissionText202.Text = "<table id='output' bgcolor='#ccffcc' width='300'><tr><td valign='middle' width='270'>" & "Scanned Instruction must be less than 1MB" & "</td><td valign='middle' width='30'><img src='images\bad.png' width='20' title='close' onclick='hide();'></td></tr></table>"
                btnSubmit202.Text = "Post Transaction"
                btnSubmit202.Enabled = True
        ...
        Catch ex1 As Exception
            Gadget.LogException(ex1)
            lblSubmissionText202.ForeColor = Drawing.Color.Red
            lblSubmissionText202.Text = "<table id='output' bgcolor='#ccffcc' width='300'><tr><td valign='middle' width='270'>" & "Error: Cannot post this transaction. Uploade PNG, JPEG, or PDF files instead" & "</td><td valign='middle' width='30'><img src='images\bad.png' width='20' title='close' onclick='hide();'></td></tr></table>"
            btnSubmit202.Text = "Post Transaction"
            btnSubmit202.Enabled = True
        ...
        t.Beneficiary = Server.HtmlEncode(txtBeneName202.Text)
        t.Beneficiary_Bank = Server.HtmlEncode(ddlBen202.SelectedItem.Text & ":" & ddlBen202.SelectedItem.Value)
        t.Beneficiary_account = Server.HtmlEncode(txtBeneficiaryAcct202.Text)
        t.date = DateTime.Now
    ...
    Private Sub mt202_cbn_Init(sender As Object, e As EventArgs) Handles Me.Init
        tid = EasyRtgTransaction.generateRef()
    End Sub

    ''' <summary>
    ''' After meeting with Ambrose (Domain Expert), it was agreed that the dropdown list of branches
    ''' no longer auto-generates the branch's suspense account. So we are commenting the method.
    ''' </summary>
