<%@ Page Language="VB" AutoEventWireup="false" CodeFile="mt103_cbn.aspx.vb" Inherits="mt103_cbn"     %>
    ...
    <div id="header" class="style1">
       ...
       <div class="wrap">
          ...
          <%-- &nbsp;&nbsp; |&nbsp;&nbsp; <a href="mytransactions.aspx">My Transactions</a>&nbsp;&nbsp; |&nbsp;&nbsp;&nbsp; 
           ...
           <fieldset>
           <legend><strong>MT103 CBN Transfers
                   ...
                   <tr>
                       ...
                       <td class="style16" valign="middle">
                           ...
                           <%--<asp:DropDownList ID="DropDownList1" runat="server" Height="26px" 
                               DataSourceID="odsBeneficiaryBank"  DataTextField="bank_name" 
                               DataValueField="bank_code" AutoPostBack="True" Width="302px" >
                           </asp:DropDownList>--%><asp:ObjectDataSource ID="odsBeneficiaryBank" runat="server" 
                   ...
                   <tr>
                       ...
                       <td class="style16" valign="middle">
                        ...
                        Height="26px" Width="302px"  Font-Size="12pt" Font-Names="Segoe UI Light" 
                           ...
                           ValidationExpression="^\d{10}$" ValidationGroup="valGroup103" Enabled="False"></asp:RegularExpressionValidator>
                           <br />
