<%@ Page Language="VB" AutoEventWireup="false" CodeFile="mt103_interbank.aspx.vb" Inherits="mt103_interbank" MaintainScrollPositionOnPostback="true"     %>
    ...
    <div id="header" class="style1">
       ...
       <div class="wrap">
          ...
          <%-- &nbsp;&nbsp; |&nbsp;&nbsp; <a href="mytransactions.aspx">My Transactions</a>&nbsp;&nbsp; |&nbsp;&nbsp;&nbsp; 
           ...
           <fieldset>
           <legend><strong>MT103 Interbank Transfers
...
<table class="style4" style="border: thin dotted #FF9933">
                   ...
                   <tr>
                       ...
                       <td class="style16" valign="middle">
                           <asp:DropDownList ID="DropDownList1" runat="server" Height="26px" 
                               ...
                               DataValueField="bank_code" AutoPostBack="True" Width="302px" >
                           </asp:DropDownList>
                       ...
                       <asp:ObjectDataSource ID="odsBeneficiaryBank" runat="server" 
                               SelectMethod="getBanks" TypeName="easyrtgs"></asp:ObjectDataSource></td>
                   </tr>
                   <tr>
                       <td class="style15" valign="middle">
         ...
         <div id="footer">
             ...
             Sterling Bank Plcg Bank Plc</div>
    <br />
    <br />
    <br />
