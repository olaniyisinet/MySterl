...
namespace BankTellerFundsTransfer.BankTeller {
    ...
    public partial class bankTeller : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public bankTeller() {
            this.Url = global::BankTellerFundsTransfer.Properties.Settings.Default.BankTellerFundsTransfer_BankTeller_bankTeller;
        ...
        public void DebitandSendtoNIBSSAsync(
                    ...
                    string cusshowname, 
                    string tellerid) {
            this.DebitandSendtoNIBSSAsync(sessionid, bracodeval, cusnumval, curcodeval, ledcodeval, subacctval, amt, fee, orignatorName, DestinationBankCode, ChannelCode, AccountName, AccountNumber, paymentRef, cusshowname, tellerid, null);
        }
        ...
        public void DebitandSendtoNIBSSAsync(
            ...
            this.InvokeAsync("DebitandSendtoNIBSS", new object[] {
                        ...
                        paymentRef,
                        cusshowname,
                        tellerid}, this.DebitandSendtoNIBSSOperationCompleted, userState);
        }
