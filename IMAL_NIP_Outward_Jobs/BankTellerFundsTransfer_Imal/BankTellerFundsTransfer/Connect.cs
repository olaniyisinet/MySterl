    ...
    class Connect
    {
        ...
        public Connect(string query)
        {
            try
            {
                ...
                conn.ConnectionString = "Data Source=SQLDB1,1490;Initial Catalog=nfpdbT24;Persist Security Info=True;User ID=etrnx;Password=(*59serv#)";
                conn.Open();
                cmd = new SqlCommand();
                cmd.Connection = conn;
        ...
        public Connect(string query, bool sql)
        {
            try
            {
               ...
               // conn.ConnectionString = "Data Source=SQLDB1,1490;Initial Catalog=nfpdbT24;Persist Security Info=True;User ID=etrnx;Password=(*59serv#)";
                conn.ConnectionString = "Data Source=10.0.41.101;Initial Catalog=nfpdb_test;User ID=sa;Password=tylent";
                conn.Open();
                cmd = new SqlCommand();
                cmd.Connection = conn;
                cmd.CommandText = query;
