...
namespace TakeUssdChargesBalEnq
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                int cnt;
                string query = "Select * from Win32_Process Where Name = 'TakeUssdChargesBalEnq.exe'";
        ...
        static DataSet getTransactions()
        {
            ...
            string sql = "select refid,sessionid,debitAccount,debitamt,transtypeid, statusflag from tbl_USSD_trnx_chrgTaken where statusflag in (0,3)  and (statusCode is null or statusCode = 'x51') and transtypeid = 2";
        ...
        static void processDS(DataSet ds)
        {
            ...
            decimal Balance_amt = 0; decimal Balance_vat = 0;
            ...
            else
            {
                ...
                for (int i = 0; i < cnt; i++)
                {
                    ...
                    if (transtypeid == 2) //balance enquiry
                    {
                        amt = Balance_amt;
