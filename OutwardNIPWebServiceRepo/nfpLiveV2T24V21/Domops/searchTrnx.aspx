<%@ Page Language="C#" MasterPageFile="~/Domops/all.master" AutoEventWireup="true" CodeFile="searchTrnx.aspx.cs" Inherits="Domops_searchTrnx" Title="NFP | Search Transaction" %>
...
<table style="background-color:#999; width:100%; border:1px solid #333;">
    <tr>
        <td colspan="4">
            <h2>Search Report From NIBSS to Sterling Bank</h2></td>
    </tr>
<tr>
    <td>
...
<asp:GridView ID="gvTransactions" runat="server" CellPadding="2"
    ...
    <Columns>
        ...
        <asp:BoundField DataField="senderbankcode" HeaderText="Senderbankcode" />
        ...
        <asp:BoundField DataField="responsecode" HeaderText="Responsecode" />
